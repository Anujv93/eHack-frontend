    ...
    return (
        <div className="certificate-page">
            ...
            */}
            ...
            {/* 14. CTA - Contact Section (matches About page design) */}
            <section className="cert-cta-section" id="cta" style={{ borderBottom: 'solid 1px #ff6b00' }}>
                <div className="container">
                    <div className="cert-cta-box">
                        <div className="cert-cta-content">
                            <div className="cert-cta-tagline">TALK TO US DIRECTLY</div>
                            <h2 className="cert-cta-title">Ready to Get <span>Certified</span>?</h2>
                            <p className="cert-cta-subtitle">
                                Speak directly with our expert counselors. We&apos;re here to guide you through the certification process and help you start your journey!
                            </p>
                        </div>
                        <div className="cert-cta-actions">
                            <a href="tel:+919886035330" className="cert-cta-btn-primary">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                Call Now: +91-9886035330
                            </a>
                            <a href="https://wa.me/919886035330" target="_blank" rel="noopener noreferrer" className="cert-cta-btn-secondary">
