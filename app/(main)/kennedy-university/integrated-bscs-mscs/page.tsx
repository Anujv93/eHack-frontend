...
/**
 * Computes the international USD price from an INR price string.
 * Formula: INR × 4 ÷ 100 = USD
 * e.g. ₹4,00,000 → 16,000 USD
 */
function computeIntlUSD(inrPrice: string): string | null {
    if (!inrPrice) return null;
    const numeric = inrPrice.replace(/[₹,\s]/g, '').match(/\d+/);
...
export default function IntegratedBSCSMSCSPage() {
    ...
    const handleFormSuccess = () => {
        ...
        link.target = '_blank';
        link.download = 'Integrated_BSCS_MSCS_Brochure.pdf';
            ...
            <section id="pricing" className="pricing-section border-bottom">
                <div className="pricing-container-full">
                    ...
                    <div className="pricing-content-wrapper">
                        {(() => {
                            // Compute international USD price from admissionFee (× 4 ÷ 100)
                            const intlUSD = computeIntlUSD(program.pricing.admissionFee);
                ...
                <div className="brochure-modal-overlay">
                    <div className="brochure-modal-container">
                        ...
                        <div className="modal-content">
                            <InquiryForm
                                courseName="Kennedy University - Integrated BSCS + MSCS (Cyber Security)"
                                courseCode="kennedy-integrated-bscs-mscs"
                                variant="popup"
