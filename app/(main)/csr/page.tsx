...
export default function CSRPage() {
    ...
    return (
        <div className="csr-page-wrapper">
                    ...
                    <div className="csr-mission-grid">
                        <div className="csr-mission-image-wrapper">
                            <Image
                                ...
                                alt="Young professionals in a cybersecurity and digital skills training workshop"
                                width={600}
                                height={450}
            ...
            {/* CTA - Contact Section (matches Certificate page Enquire Now design) */}
            <section className="csr-cta-contact-section" style={{ borderBottom: 'solid 2px #ff6b00' }}>
                <div className="container">
                    <div className="csr-cta-box">
                        <div className="csr-cta-content">
                            <div className="csr-cta-tagline">PARTNER WITH US</div>
                            <h2 className="csr-cta-title">Build a Safer, <span>Smarter India</span></h2>
                            <p className="csr-cta-subtitle">
                        ...
                        <div className="csr-cta-actions-box">
                            <a href="tel:+919886035330" className="csr-cta-btn-primary">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                Call Now: +91-9886035330
                            </a>
                            <a href="https://wa.me/919886035330" target="_blank" rel="noopener noreferrer" className="csr-cta-btn-whatsapp">
