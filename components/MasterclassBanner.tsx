...
export default function MasterclassBanner({ data }: MasterclassBannerProps) {
  ...
  const pairs = [
      { text: "$100M Offers", book: "/images/books/100m-offers.jpg", author: "/images/books/Alex-Hermozi-Freelancing-removebg-preview.png", authorScale: "h-[180px]" },
      { text: "$100M Leads", book: "/images/books/100m-leads-original-imagvjkcv3cgu8mf.webp", author: "/images/books/Alex-Hermozi-Freelancing-removebg-preview.png", authorScale: "h-[180px]" },
      { text: "Purple Cow", book: "/images/books/purple-cow.jpg", author: "/images/books/seth%20godin.png", authorScale: "h-[160px]" },
      { text: "Traffic Secrets", book: "/images/books/traffic-secrets.jpg", author: "/images/books/Russell%20Brunson.png", authorScale: "h-[180px]" },
      { text: "22 Immutable Laws", book: "/images/books/22-laws.jpg", author: "/images/books/al%20rise.png", authorScale: "h-[180px]" }
  ];
  ...
  return (
    <section id="masterclass-section" className="w-full py-12 px-4 sm:px-6 flex justify-center bg-[#f8fafc]">
      
      {/* Banner Container */}
      <div className="relative w-full max-w-[1300px] bg-white rounded-[2rem] shadow-[0_15px_50px_rgba(0,0,0,0.1)] border border-gray-200 overflow-hidden flex flex-col lg:flex-row min-h-[550px]">
        
        {/* === BACKGROUND SHAPES (Sweeping Curves) === */}
        {/* Dark Slate Base Curve */}
        <div className="absolute top-[20%] right-[-10%] w-[120%] lg:w-[75%] h-[150%] bg-[#111827] rounded-[100%] rotate-[-12deg] origin-top-right z-0"></div>
        {/* Primary Orange Curve */}
        <div className="absolute top-[35%] right-[-5%] w-[120%] lg:w-[70%] h-[150%] bg-[#ff6b00] rounded-[100%] rotate-[-15deg] origin-top-right z-0"></div>
        ...
        <div className="w-full lg:w-[40%] relative z-10 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
          
          <div className="font-bold text-gray-900 tracking-widest text-sm uppercase mb-6 flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-[#ff6b00]"></div>
            Digital Marketing
          </div>

          <div className="mb-6">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black leading-[1.1] text-gray-900 tracking-tight flex flex-col">
              <span className="font-serif italic font-medium text-3xl md:text-4xl text-[#ff6b00] mb-1">7-Day Live</span>
          ...
          <div className="bg-[#fff7f0] border border-[#ff6b00]/20 rounded-xl p-4 mb-6 max-w-sm">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[#ff6b00] font-extrabold text-sm">40% OFF</span>
            </div>
            <div className="flex items-baseline gap-2.5 mb-2">
              <span className="text-gray-400 line-through text-base font-medium">₹7,000</span>
              <span className="text-gray-900 font-black text-2xl md:text-3xl">₹4,200</span>
            </div>
          ...
          <div className="mt-auto flex items-center gap-4">
            <button className="bg-[#ff6b00] hover:bg-[#e56000] text-white font-bold py-3.5 px-8 rounded-full transition-all duration-300 shadow-[0_8px_20px_rgba(255,107,0,0.3)] hover:-translate-y-1">
              Generate Invoice
            </button>
            <div className="flex flex-col">
              <span className="text-[10px] uppercase font-bold text-gray-400 tracking-widest">Call For Details</span>
              <span className="text-sm font-black text-gray-900">+91-9513393880</span>
            </div>
          </div>
        </div>

        {/* === RIGHT COLUMN: Creative GSAP Animation & Curriculum === */}
        <div className="w-full lg:w-[60%] relative z-10 p-8 md:p-12 flex flex-col lg:flex-row items-center justify-end gap-8 lg:gap-12 min-h-[550px]">
          
          {/* Creative GSAP 3D Floating Book/Author Animation */}
          <div ref={animationContainerRef} className="relative w-full max-w-[280px] h-[280px] lg:absolute lg:left-0 lg:top-[30%] lg:-translate-y-1/2 lg:-translate-x-[25%] z-20 flex-shrink-0 mx-auto lg:mx-0 mt-0 lg:mt-0 perspective-[1000px]">
            {/* Ambient Background Glow for the floating elements */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-white/10 blur-[50px] rounded-full z-0"></div>
            ...
            {pairs.map((pair, idx) => (
              <div key={idx} className="creative-slide absolute inset-0 w-full h-full flex flex-col items-center justify-end z-10 opacity-0 pointer-events-none">
                ...
                <div className="relative w-full h-[220px] flex items-end justify-center">
                   ...
                   <img 
                      src={pair.book} 
                      className="book-img absolute right-4 lg:right-0 bottom-4 w-[110px] h-[155px] rounded-md shadow-[0_15px_30px_rgba(0,0,0,0.6)] object-cover z-10 border-[3px] border-white" 
                      alt="Book Cover"
                   />
                   {/* Author Image */}
                   <img 
          ...
          <div className="w-full max-w-[480px] lg:ml-auto relative z-30 bg-[#fff0e6] rounded-2xl border border-orange-200/50 p-6 shadow-[0_20px_40px_rgba(17,24,39,0.2)] h-[480px] flex flex-col mb-4 lg:mb-0">
            <div className="flex items-center justify-between border-b border-orange-200 pb-4 mb-5">
              <h3 className="text-gray-900 font-black uppercase tracking-widest text-base">
                Curriculum Schedule
              </h3>
              <span className="text-[11px] text-[#ff6b00] font-bold bg-[#ff6b00]/10 px-3 py-1 rounded-full border border-[#ff6b00]/20">
                7 Modules
              </span>
            </div>
